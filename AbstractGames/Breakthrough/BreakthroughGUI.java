...
public class BreakthroughGUI extends JApplet {
  ...
  private BreakthroughCustomPanel boardPanel;
  ...
  public void buildGUI() {
    ...
    boardPanel = new BreakthroughCustomPanel(this);
    ...
    if (s.equals("White")) {
      ...
      startAsBlack = false;
      boardPanel.user_move = BreakthroughCustomPanel.WAIT1;
...
//	    board.searchtime = temp*1000;
  ...
  public static void main(String s[]) {
    ...
    BreakthroughGUI id = new BreakthroughGUI();
    id.buildGUI();
    frame.add("Center", id);
    frame.pack();
