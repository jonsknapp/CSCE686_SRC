...
public class BreakthroughMove extends Move{
  /**
   * Source coordinates in the range 0-BOARD_SIZE-1, 0-BOARD_SIZE-1.
   */
  public int x1, y1;
  /**
   * Destination coordinates in the range 0-BOARD_SIZE-1, 0-BOARD_SIZE-1.
   */
  public int x2, y2;

  public int value;            // How good this move was
  public double val;           // this one is for the hash table/RL/ACO

  public BreakthroughPiece piece;          // The piece that is being moved
  public BreakthroughPiece captured_piece; // If a piece is captured store it as well.
   ...
   */
  public BreakthroughMove(String desc) {
   ...
   * @param y2 Ending row.
   */
  public BreakthroughMove(int x1, int y1, int x2, int y2) {
    this.x1 = x1;
    this.y1 = y1;
    this.x2 = x2;
    this.y2 = y2;
   ...
   */
  public BreakthroughMove(int x1, int y1, int x2, int y2, int value) {
    this.x1 = x1;
    this.y1 = y1;
    this.x2 = x2;
    this.y2 = y2;
   ...
   * @param p     Piece
   */
  public BreakthroughMove(int x1, int y1, int x2, int y2, int value, BreakthroughPiece p) {
    this.x1 = x1;
    this.y1 = y1;
    this.x2 = x2;
    this.y2 = y2;
   ...
   * @param m Move
   */
  public void copy(BreakthroughMove m) {
    x1 = m.x1;
    y1 = m.y1;
    x2 = m.x2;
    y2 = m.y2;
